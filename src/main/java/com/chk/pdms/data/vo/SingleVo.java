...
public class SingleVo {
    @ExcelIgnore
    public static String sheet = "单层芯片";

    @ExcelIgnore //TODO? 有两个？？？
    public String orderRule = "质量等级| |产品型号|-|封装及外形尺寸|-|温度特性/系数|-|电压|-|电容||精度/容量偏差|-|引出端形式|-|电极材料代码|-|执行标准__质量等级| |产品型号|-|封装及外形尺寸|-|温度特性/系数|-|电压|-|电容||精度/容量偏差|-|电极材料代码|-|电容数量|-|执行标准";


    @ExcelIgnore
    private String orderRule2 = "质量等级| |产品型号|-|封装及外形尺寸|-|温度特性/系数|-|电压|-|电容||精度/容量偏差|-|电极材料代码|-|电容数量|-|执行标准";
