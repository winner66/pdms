...
public class PinVo {
    @ExcelIgnore
    public static String sheet = "多芯组";

    @ExcelIgnore
    public String orderRule = "质量等级| |产品型号|-|封装及外形尺寸||引脚形状|-|温度特性/系数|-|电压|-|电容||精度/容量偏差";
//    public String orderRule = "质量等级| |产品型号|-|封装及外形尺寸||引脚形状|-|温度特性/系数|-|电压|-|电容||精度/容量偏差|-|执行标准";
